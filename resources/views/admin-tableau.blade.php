    ...
    <div class="container-xxl row m-0 p-0">
            ...
            <div class="container d-flex gap-4 flex-column">
                ...
                <div class="collapse navbar-collapse mt-4" id="navbarContent">
                    <ul class="ms-2 nav flex-column gap-4 mt-5 nav-fill nav-pills nav-justified">
                        <!-- Lien actif - Vue d'ensemble -->
                        <li class="nav-item text-start">
                            <a class="nav-link active" aria-current="page" href="{{ url('/admin') }}"><i class='bx bx-globe'></i> Vue d'ensemble</a>
                        </li>
        ...
        <main class="col-lg-9 col-md-8 p-4">
            ...
            <div class="row mb-4 g-4">
                ...
                <!-- Carte Trajets du jour -->
                <div class="col-md-12 col-lg-6">
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="text-muted mb-2">Trajets aujourd'hui</h6>
                                    <h3 class="mb-0">18</h3>
                                </div>
                                <div class="bg-warning bg-opacity-10 p-3 rounded">
                                    <i class='bx bx-map text-warning fs-4'></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card shadow-sm border-0 mt-5" style="height: 60vh;">
                <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ url('/admin-rapport') }}" class="btn btn-sm btn-outline-primary">Voir tout</a>
                </div>
                <div class="card-body">
