...
<head>
    ...
    <title>TransGabon - Inscription Client</title>
    ...
    <div class="custom-shape-divider-top-1745201171">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            ...
            <defs>
                ...
                <!-- Dégradé de couleur bleu pour la forme décorative -->
    ...
    <div class="container position-relative">
        ...
        <div class="container row vh-100 justify-content-center align-items-center">
            ...
            <div class="bg-white col-12 col-md-6 h-75 border border-2 border-light-subtle shadow rounded-3 p-4 gap-2 d-flex flex-column gap-3 mt-3">
                <h2 class="mb-2 mt-2">Inscription</h2>
                <p class="mb-0">Bienvenue dans votre espace client</p>
                
                <!-- Formulaire d'inscription -->
                <form action="" class="d-flex gap-3 flex-column">
                    <!-- Ligne 1 : Nom et Prénom -->
                    <div class="row">
                        <!-- Champ Nom -->
                        <div class="col col-md-6">
                            <label for="nom" class="form-label">Nom</label>
                            <input type="text" class="form-control shadow-sm" id="nom" placeholder="Entrez votre nom" required>
                        </div>
                        <!-- Champ Prénom -->
                        <div class="mb-3 col col-md-6">
                            <label for="prenom" class="form-label">Prénom</label>
                            <input type="text" class="form-control shadow-sm" id="prenom" placeholder="Entrez votre prénom" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-6">
                            ...
                            <input type="email" class="form-control shadow-sm" id="email" placeholder="Entrez votre email" required>
                        </div>
                        <!-- Champ Téléphone -->
                        <div class="col col-md-6">
                            <label for="telephone" class="form-label">Téléphone</label>
                            <input type="tel" class="form-control shadow-sm" id="telephone" placeholder="Entrez votre numéro de téléphone" required>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-bleu rounded-pill p-2 fs-5 text-uppercase shadow">Inscription</button>
                    
                    <!-- Lien vers la page de connexion -->
                    <div class="mt-1 text-center">
                        Déjà inscrit? <a href="{{ url('/connexion-client') }}" class="text-decoration-none">Se connecter</a>
                    </div>
                </form>
            </div>
        </div>
